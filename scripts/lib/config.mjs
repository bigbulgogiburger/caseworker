...
export const DEFAULTS = Object.freeze({
  ...
  protected: [],
  herdr: { enabled: true, notify: true, lanes: 'off', kinds: { verify: ['codex'], implement: ['claude'], maker: ['claude'], verifier: ['codex'] }, kind_args: {}, lane_timeout_s: 900, reviewer_context: 'issue', close_panes: false },
