...
5. **설명은 적당히만 구체화** — grill 문답·plan 단계(`/caseworker:issue`)가 후속에서 채운다.
...
- description은 라이트하게 — 후속 grill 문답·plan 단계(`/caseworker:issue`)가 채울 여지를 남긴다. 처음부터 5페이지짜리 설계 문서 만들지 않는다.
